...
QT_MOC_LITERAL(1, 6, 8), // "isPlayer"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 14) // "addRobotToList"

    },
    "Scene\0isPlayer\0\0addRobotToList"
};
...
void Scene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->isPlayer(); break;
        case 1: _t->addRobotToList(); break;
        default: ;
        }
        ...
        {
            using _t = void (Scene::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Scene::isPlayer)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Scene::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Scene::addRobotToList)) {
                *result = 1;
                return;
            }
        }
