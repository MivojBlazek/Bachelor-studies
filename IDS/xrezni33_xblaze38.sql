...
BEGIN
    SELECT Minimalni_vyse_pokuty, Maximalni_vyse_pokuty
    INTO Min_pokuta, Max_pokuta
    FROM Prestupek
    WHERE ID_prestupku = :NEW.ID_prestupku;
...
INSERT INTO Spachal(Rodne_cislo_ridice, ID_prestupku, Datum_spachani, Popis, Vyse_pokuty)
VALUES ('915624/0321', 4, TO_DATE('2024-03-21', 'YYYY-MM-DD'), 'Auticko nezastavilo na semaforech ale dostalo spatnou vysi pokuty', 1.00);
COMMIT;
