...
<head>
    ...
    <style>
        ...
        * {
        ...
        button i {
            transition: transform 0.2s ease; /* Smooth transition on click */
        }
...
<body>
    ...
    <div class="sort-options">
        <form method="GET" action="{{ route('FYP') }}">
            ...
            <div class="post">
                ...
                <div class="post-content">
                    ...
                    <form action="{{ route('FYP.like') }}" method="POST" style="display: inline;">
                        @csrf
                        <input type="hidden" name="postId" value="{{ $post->postId }}">
                        <button type="submit" style="background: none; border: none; color: #3897f0; font-size: 18px; cursor: pointer;">
