...
Čím více \textsc{druhů}, \emph{řezů}, {\scriptsize velikostí}, {\color{red} barev} písma a jiných \texttt{efektů} použijeme, \underline{tím profesionálněji} bude {\fontfamily{pzc}\selectfont dokument} vypadat.
